...
let db = JSON.parse(fs.readFileSync('./config/dataBase.js', 'utf8')).sort((a, b) => {
...
let viewAllMovies = (req, res) => {
    fs.readFile(viewMoviesPath, (err, data) => {
        ...
        db = JSON.parse(fs.readFileSync('./config/dataBase.js', 'utf8')).sort((a, b) => {
                return Number(b.movieYear) - Number(a.movieYear);
            }
        );
        ...
        req.on('data', chunk => {
            ...
            .on('end', () => {
                ...
                if (valid) {
                    ...
                    fs.writeFileSync('./config/dataBase.js', JSON.stringify(db), 'utf8');
